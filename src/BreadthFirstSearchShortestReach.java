...
public class BreadthFirstSearchShortestReach {
    ...
    /**
     * Represents Node of the graph and contains node id along with the nodes
     ...
     * 
     * @param N
     *            containing total number of nodes.
     * @param node1
     *            First node of the nodes to calculate distance between.
     * @param node2
     *            Second node of the nodes to calculate distance between.
